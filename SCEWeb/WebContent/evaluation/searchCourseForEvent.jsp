...
<script language="javascript">
    ...
    function searchCourse(){        
        ...
        if(submit==true){
        clearSelectedValues();
        document.forms[0].action="searchCourseDetailsForEvent.action?courseName="+courseName+"&courseCode="+courseCode;
    ...
    function validateAndInsert(){
      ...
      //  window.opener.evalTemplLmsCourseMapping.hiddenCourseCodes.value = strCourseCodes;
       //  window.opener.evalTemplLmsCourseMapping.imgSaveMappingName.src = tempVal+"/evaluation/resources/_img/button_save.gif";
        // alert(window.opener.parentFunction);
...
<link
	...
	rel="stylesheet" type="text/css" media="all" />
<link
	href="<%=request.getContextPath()%>/evaluation/resources/_css/sorttable.css"
	rel="stylesheet" type="text/css" media="all" />
...
<body id="p_search_results" class="search" onload="retainValues()">
	<div id="wrap">
		...
		<div id="main_content">
			<form name="searchLmsCourse" id="searchLmsCourse">

				<!-- Search Criteria block -->
				<table width="90%"
					style="border: 0; cellpadding: 0; cellspacing: 0; align: left"
					class="evalmappingtable">
					<tr>
						<td width="40%" class="evalmappingtd" align="left"
							style="font-weight: bold; font-color: black">Course Name</td>
						<td width="5%" class="evalmappingtd" align="left">&nbsp;</td>
						<td width="40%" class="evalmappingtd" align="left"
							style="font-weight: bold; font-color: black">Course Code</td>
						<td width="15%" class="evalmappingtd" align="left">&nbsp;</td>
					</tr>
					<tr>
						<td width="40%" class="evalmappingtd"><input type="text"
							id="txtCourseName" size="60" style="width: 99%;"
							name="courseName" align="left" border="1" value=""> <input
							type="hidden" id="hdnSrchCourseName" name="hdnSrchCourseName"
							align="left" border="1" value=""></td>
						<td width="5%" class="evalmappingtd"><b>&nbsp;&nbsp;OR&nbsp;&nbsp;</b></td>
						<td width="40%" class="evalmappingtd" align="left"><input
							type="text" id="txtCourseCode" size="60" style="width: 99%;"
							name="courseCode" align="left" value=""> <input
							type="hidden" id="hdnSrchCourseCode" name="hdnSrchCourseCode"
							align="left" border="1" value=""></td>
						<td width="15%" class="evalmappingtd" align="left"><img
							id="imgSearchCourse"
							src="<%=request.getContextPath()%>/evaluation/resources/_img/button_search.gif"
							style="width: 56px; height: 19px" onclick="searchCourse()"
							alt="Search Course"></td>
					</tr>
				...
				<% if(courseDetails!=null && courseDetails.length!=0){
                    CourseDetails objCourseDetails = null;
                        if(!message.equals("")){%>
				<table width="90%" id="tblmessage" style="align: center" border="0"
					cellspacing="0" cellpadding="0" style="display:block;"
					class="evalmappingtable">
					<tr>
						<td width="100%" class="evalmappingtd"><font
							style="color:red; font-size:1.1em; font-family: 'Lucida Grande', 'Trebuchet MS', 'Arial';"><%=message%></font>
						</td>
					</tr>
				</table>
				...
				<table class="sortable" width="90%" id="tblSearchResults" border="0"
					cellspacing="0" cellpadding="0" style="display: block;">
					...
					<tr>
						<th><input type="checkbox"
							style="height: 12px; width: 12px; align: center; valign: bottom"
							id="checkUnchkAllId" name="checkUnchkAll"
							onclick="toggleSelection(this)"></th>
						<!--<th width="15%"><b>Select All</b></th>-->
						<th onclick="ts_resortTable(this, 1);return false;"><b><u>Course
								Name</u></b></th>
						<th onclick="ts_resortTable(this, 2);return false;"><b><u>Course
								Code<u></b></th>
					...
					<tr>
						<td width="10%"><input type="checkbox"
							style="height: 12px; width: 12px; align: center; valign: bottom"
							name="chkCourseMapping" id="chkCourseMapping_<%=i%>"
							onclick="setSelectedValues(this, '<%=courseDetails[i].getCourseId()%>', '<%=escCourseName%>', '<%=chkNull.isNull((courseDetails[i].getCourseCode()))%>', '<%=i%>')">
						</td>
						<!--<td width="15%">&nbsp;</td>-->
						<td width="40%"><%=escCourseName.replaceAll("%27", "\'")%></td>
						<td width="40%"><%=chkNull.isNull((courseDetails[i].getCourseCode()))%></td>
						<input type="hidden" id="hdnActivityPk_<%=i%>"
							name="hdnActivityPk" value="<%=courseDetails[i].getCourseId()%>">
						<input type="hidden" id="hdnCourseName_<%=i%>"
							name="hdnCourseName"
							value="<%=escCourseName.replaceAll("%27", "\'")%>">
						<input type="hidden" id="hdnCourseCode_<%=i%>"
							name="hdnCourseCode"
							value="<%=chkNull.isNull((courseDetails[i].getCourseCode()))%>">
					</tr>
				...
				<table width="100%" style="border: 0; align: left; display: block;">
					<tr>
						<td width="100%" colspan="3" class="evalmappingtd"><img
							id="insertSel" name="insertSelected"
							src="<%=request.getContextPath()%>/evaluation/resources/_img/button_insert_selected.gif"
							style="width: 89px; height: 19px" onclick="validateAndInsert()"
							alt="Insert Selected"> <!--<input type="button" name="insertSelected" id="insertSel" value="Insert Selected" onclick="validateAndInsert()">-->
							&nbsp;&nbsp; <!--<input type="button" name="closeWindow" id="closeWin" value="Close" onclick="closePopUp()">-->
							<img id="closeWin" name="closeWindow"
							src="<%=request.getContextPath()%>/evaluation/resources/_img/btn_close.gif"
							style="width: 42px; height: 19px" onclick="closePopUp()"
							alt="Close"></td>
				...
				<table width="90%" id="tblNoResults" border="0" cellspacing="0"
					cellpadding="0" style="display: block;" class="evalmappingtable"
					align="center">
					<tr>
						<td width="100%"><font
							style="color:red; font-size:1.1em; font-family: 'Lucida Grande', 'Trebuchet MS', 'Arial';"><%=message%></font>
