...
// System.out.println("request getParameter :: "+request.getParameter("templateVersionId"));
if(request.getParameter("templateVersionId")!=null){
templateVersionId=new Integer(request.getParameter("templateVersionId"));

// System.out.println(request.getParameter("templateVersionId"));

// System.out.println("request templateVersionId ::"+templateVersionId);
...
<script language="javascript">
        ...
        function validateDate(){
            ...
            if (useDate > today ){
                alert("The Evaluation Date can not be a future date. Please provide todays's Date or a past Date");
                return false;
            }
