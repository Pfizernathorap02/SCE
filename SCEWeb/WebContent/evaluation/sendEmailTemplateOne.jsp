...
else
{
 ...
 {condition = con1;
  ...
  //String emailBody = " Hi,\n" + " You have been selected for Event: " + eventName +  ".%20%0d%0a" ;
 // emailBody  = emailBody + "Please Click on link below to accept:"+ "%20%0d%0ahttp://sceint.pfizer.com ";
  //emailBody  = emailBody + "%20%0d%0a%20%0d%0aThanks and Regards," + "  %20%0d%0aSCE TEAM;   ";
...
//var contentBodyP = contentBodyN.replace(/&/g,"%26");             /*comented   */
//var contentBody = contentBodyP.replace(/\r\n|\n/g,"%20%0d%0a");  /*commented  */

var contentBody = contentBodyN; /*Jan release- Changes done to resolve the content issue*/
//alert(contentBody);
							...
							<table style="width: 600px;" width="30%">
								...
								<tr>
									...
									<td style="width: 40%; border: 0;"><input
										...
										size=50 value="Guest Trainer Invitation for <%=eventName%>"></input></td>
								</tr>
								<tr>
...
Please confirm your availability for the <%=eventName%> between <%=formatteddates%> and <%=endDate%> by clicking the link below 
...
<!--Jan release simi begin- Changes done to resolve the content issue-->
...
<!--Jan release simi end- Changes done to resolve the content issue-->
