        ...
        function hideElement( elmID, overDiv ) {
				...
				var hiderow=false;
                                ...
                                if(objTop>overDiv.offsetTop){
                                  if(objTop<(overDiv.offsetTop+overDiv.offsetHeight)){
                                    if((objTop+objHeight)>overDiv.offsetTop){
                                      hidecol=true;
                                    }
                                  }
                                }else{
        ...
        */
                ...
                if (bPageLoaded) {
                        if (crossobj.visibility == 'hidden') {
                               ...
                               ctlToPlaceValue = getObj(ctl2,'');
                                ...
                                tokensChanged = 0;
                                  if (formatChar != "") {
                                		var controlObject = getObj(ctl2, '');
                                		aData =	controlObject.value.split(formatChar);
                                        for (i=0; i<3; i++) {
        ...
        //Added by Taqi: 10/26/2004 This method returns object on the form
